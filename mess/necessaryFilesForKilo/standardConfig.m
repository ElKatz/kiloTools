...
%% Katz's editions:
% Changed it slightly so that all paths are set in the master file, not
% here. Here you just set your desired sorting config.

ops.dirDatasets         = dirDataset; % save into ops struct so it feeds the master.m file
ops.savePreAutoMerge    = true; % save rez & npy files before the autoMerge?
